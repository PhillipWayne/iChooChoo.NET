...
void processGenPurpSet()
{
  ...
  {
    iOutputs[bfrIN[1] - BICCP_CMD_GENPURP_OUT_STR] = (bfrIN[2] == 0xFF ? HIGH : LOW);
...
//  digitalWrite(A6, iOutputs[0] ? HIGH : LOW);
  ...
  digitalWrite(7,  iOutputs[2] ? HIGH : LOW);
  digitalWrite(8,  iOutputs[3] ? HIGH : LOW);
  digitalWrite(12, iOutputs[4] ? HIGH : LOW);
  digitalWrite(13, iOutputs[5] ? HIGH : LOW);
  digitalWrite(A0, iOutputs[6] ? HIGH : LOW);
  digitalWrite(A1, iOutputs[7] ? HIGH : LOW);
  digitalWrite(A2, iOutputs[8] ? HIGH : LOW);
  digitalWrite(A3, iOutputs[9] ? HIGH : LOW);

  digitalWrite(3,  iOutputs[0xA] ? HIGH : LOW);
  digitalWrite(5,  iOutputs[0xB] ? HIGH : LOW);
  digitalWrite(6,  iOutputs[0xC] ? HIGH : LOW);
  digitalWrite(9,  iOutputs[0xD] ? HIGH : LOW);
  digitalWrite(10, iOutputs[0xE] ? HIGH : LOW);
  digitalWrite(11, iOutputs[0xF] ? HIGH : LOW);
}
