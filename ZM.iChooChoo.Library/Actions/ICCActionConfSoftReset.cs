...
{
    /// <summary>
    /// Class containing a module configuration Soft Reset action.
    /// </summary>
    public class ICCActionConfSoftReset : ICCActionConf
    {
        /// <summary>
        /// Instantiates a new ICCActionConfSoftReset.
        /// </summary>
        public ICCActionConfSoftReset() : base()
        {
            Command = ICCConstants.BICCP_CMD_CONF_SOFTRST;
        ...
        {
            return string.Format("DO_SOFTRESET {0:x2}\n", Address);
        }
        ...
        public override bool ToBICCP(IBICCPManager biccp, IBICCPData answer)
        {
            ...
            Log?.LogMessage(b, "SoftReset", Address);
