...
{
    /// <summary>
    /// Class containing a lighting module start fire scenario action.
    /// </summary>
    public class ICCActionLightingScenarioStartFire : ICCActionLightingScenarioStart
    {
        /// <summary>
        /// Instantiates a new ICCActionLightingScenarioStartFire.
        /// </summary>
        public ICCActionLightingScenarioStartFire() : base()
        {
        }
        ...
        public override bool ToBICCP(IBICCPManager biccp, IBICCPData answer)
        {
            ...
            {
                if (biccp.RequestToModule(Address, answer, Group, Command, (byte)Data[0], (byte)p[0], (byte)p[1], (byte)p[2], (byte)(p[2] >> 8)))
        ...
        {
            int[] p = (int[])Data[1];
            return string.Format("{0}, output={1:x2}, output2={2:x2}, fireSpeed={3}", base.ToString(), p[0], p[1], p[2]);
        }
    }
}
