...
{
    /// <summary>
    /// Class containing a lighting module set output action.
    /// </summary>
    public class ICCActionLightingSetOutput : ICCActionLighting
    {
        /// <summary>
        /// Instantiates a new ICCActionLightingSetOutput.
        /// </summary>
        public ICCActionLightingSetOutput() : base()
        {
        ...
        public override bool ToBICCP(IBICCPManager biccp, IBICCPData answer)
        {
            ...
            Log?.LogMessage(b, string.Format("LightingModule: Set output {0:X} to {1:X2}", (byte)Data[0], outValue), Address);
